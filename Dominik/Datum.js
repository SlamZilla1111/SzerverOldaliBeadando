...
var startDate = '2022-10-22T00:00';
var endDate = '2022-10-28T00:00';
...
var select = mobiscroll.select('#date-filtering-select', {
    ...
    onChange: function (event) {
        ...
        if (selected === 'custom') {
            ...
            switch (selected) {
                case 'today':
                    calendar.setVal(['2022-10-22T00:00', '2022-10-22T00:00']);
                    break;
                case 'yesterday':
                    calendar.setVal(['2022-10-21T00:00', '2022-10-21T00:00']);
                    break;
                case 'last-week':
                    calendar.setVal([new Date(now.getFullYear(), now.getMonth(), monday - 7), new Date(now.getFullYear(), now.getMonth(), monday - 1)]);
                    break;
                case 'last-month':
                    calendar.setVal(['2022-09-01T00:00', '2022-09-30T00:00']);
                    break;
                case 'last-7-days':
                    calendar.setVal(['2022-10-16T00:00', '2022-10-22T00:00']);
                    break;
                case 'last-30-days':
                    calendar.setVal(['2022-09-23T00:00', '2022-10-22T00:00']);
                    break;
            }
        }
    }
